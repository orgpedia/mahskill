...
import/websites/gr.maharashtra.gov.in/Skill:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Skill .
...
import: check_env import/websites/gr.maharashtra.gov.in/Skill .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Skill import/documents
